    ...
    const submitForm = async (e) => {
        ...
        try{
            ...
            if (!email.match(userRegex)) {             
                toast.error('Not the right email syntax!');
                console.log("email", value.email);
                console.log("password", value.password);
            } else {               
            ...
            push('/home');
            toast.success('Welcome to DiegolovesLina.com!');
            } 
        } catch {
                    ...
                    <Grid container spacing={3}>
                        ...
                        <Grid item xs={12}>
                            ...
                            <Grid className="formFooter">
                                <Button fullWidth disable={buttonVisibility} className="cBtnTheme" type="submit">Login</Button>
                            </Grid>
